  ...
  switch (particle.renderType) {
    case 'ghost':
      ...
      drawSpriteUV(
        ...
        ghostPngParams.FRAME_WIDTH,
        ghostPngParams.FRAME_HEIGHT,
        ghostPngParams.FRAME_COUNT,
      );
      break;
    case 'splat':
      ...
      drawSpriteUV(
        ...
        splatPngParams.FRAME_WIDTH,
        splatPngParams.FRAME_HEIGHT,
        splatPngParams.FRAME_COUNT,
      );
      break;
    case 'blood':
      tia.rectFill(
        ...
        particle.x,
        particle.y,
        particle.x + 10 * energyRatio,
        particle.y + 10 * energyRatio,
        0xff0000,
      );
      break;
    default:
